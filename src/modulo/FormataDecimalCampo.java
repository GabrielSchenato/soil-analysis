...
/*Classe para permitir formatar o campo no momento em que o usr digita ou cola um texto no campo.
 Exemplo de uso: 
 jFormattedTextFieldAL.setDocument(new FormataDecimalCampo(10,2));*/

import javax.swing.text.*;

public final class FormataDecimalCampo extends PlainDocument {

    private static final SimpleAttributeSet nullAttribute = new SimpleAttributeSet();
    private int qtdaDigitos;
    private int casasDecimais;

    public FormataDecimalCampo(int qtdaDigitos, int casasDecimais) {
